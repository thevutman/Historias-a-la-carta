...
export default function EnhancedImageSection() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-20 bg-white text-stone-900">
      <div className="md:h-screen my-16 md:my-0 max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between ">
        <div className="md:w-1/2 mb-8 md:mb-0 mb:order-1">
      ...
      <div className="md:h-screen my-16 md:my-0 max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center ">
