    ...
    <div className="flex flex-col items-center justify-center gap-20 bg-white text-stone-900">
      ...
      <div ref={section2Ref} className="h-screen max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between ">
        <div className="md:w-3/6 mb-8 md:mb-0">
          <p ref={paragraph2Ref} className='text-xl text-stone-900 opacity-0'>A partir de la década de 1750, la producción de derivados de la leche comenzó a expandirse. Se integraron técnicas españolas para la elaboración de productos lácteos, adaptadas a las realidades locales. Así, surgieron productos como los quesos frescos, las natillas y los dulces de leche. La combinación de leche con azúcar de caña permitió la creación de postres cremosos que se convirtieron en una parte esencial de la dieta regional.</p>
        </div>
        <div className="md:w-3/6 flex justify-center">
          <div className="w-5/6">
      ...
      <div ref={paragraph3Ref} className="h-screen max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center opacity-0">
        <div className="md:w-3/6 mb-8 md:mb-0">
